            ...
            <div className="scroll-sidebar">
                <nav className="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        >
                            <Link className="sidebar-link waves-effect waves-dark sidebar-link" aria-expanded="false" to="/">
                        ...
                        >
                            <Link className="sidebar-link waves-effect waves-dark sidebar-link" to="/master-recipients">
                        ...
                        >
                            <Link className="sidebar-link waves-effect waves-dark sidebar-link" to="/templates">
